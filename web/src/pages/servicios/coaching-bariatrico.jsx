...
export default function CoachingBariatricoPost() {
  ...
  return (
    <>
      {/* SEO Metadata */}
      <Helmet>
        <title>Coaching Bariátrico - Blanca de Uña Martín</title>
        <meta
          name="description"
          content="Descubre cómo el coaching bariátrico puede ayudarte en tu proceso de cirugía bariátrica, apoyándote en la adaptación emocional y conductual para un cambio de vida sostenible."
        />
        <meta
          name="keywords"
          content="coaching bariátrico, cirugía bariátrica, bienestar emocional, psicología, adaptación al cambio"
        />
